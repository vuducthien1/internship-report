...
| RDS Snapshots | RDS → Snapshots | Nhấp chọn các snapshot sinh ra trong quá trình xóa → **Actions** → **Delete** |

![cleanup](https://hoaithoai.github.io/images/5-Workshop/5.7-Cleanup/5-7.png)
![stack delete](https://hoaithoai.github.io/images/5-Workshop/5.7-Cleanup/5-7-4.png)
![secrets cleanup](https://hoaithoai.github.io/images/5-Workshop/5.7-Cleanup/5-7-3.png)
